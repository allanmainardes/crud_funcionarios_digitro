...
{   
    ...
    public function findEmployeeById($idUser)
    {
        ...
        $stmt = $this->conn->prepare("SELECT * FROM tb_employees WHERE id_func=:id_func");
    ...
    {
        $stmt = $this->conn->prepare("SELECT * FROM tb_employees");
        $stmt->execute();
    ...
    {   
        ...
        INSERT INTO tb_employees(nome_func, cpf_func, email_func, estado_civil_func, dt_nascimento_func) 
    ...
    public function updateEmployee($aData)
    {
        ...
        $this->conn->beginTransaction();
        $stmt = $this->conn->prepare("
        UPDATE tb_employees SET nome_func = :func_nome, cpf_func = :func_cpf, email_func = :func_email, 
    ...
    public function removeEmployee($id){
        $this->conn->beginTransaction();
        $stmt = $this->conn->prepare("DELETE FROM tb_employees WHERE id_func = :func_id");
